...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-6 relative overflow-hidden">
            <Helmet>
                <title>Login | Dochi Bonds</title>
                <meta name="description" content="Login to your Dochi Bonds account." />
            </Helmet>
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400">Enter your credentials to access your portfolio.</p>
                </div>
                ...
                <div className="mt-8 text-center text-sm text-gray-500">
                    Don't have an account? <Link to="/signup" className="text-blue-500 font-bold hover:underline">Create one</Link>
                </div>
            </motion.div>
        </div>
    );
